...
return new class extends Migration
{
    ...
    {
        Schema::create('cliente_seguro_propriedade', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('id_propriedade')->references('id')->on('propriedade_cliente')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('cliente_seguro_propriedade');
    }
};
