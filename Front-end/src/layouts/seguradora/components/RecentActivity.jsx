  ...
  const activities = [
    {
      ...
      details: 'Cliente: João Silva | Valor: MZN 8.500,00 | Seguro: Auto Premium',
    ...
    },
    {
      ...
      details: 'Apólice #7891 | Valor: MZN 2.500,00/ano | Vigência: 12 meses',
    ...
    },
    {
      ...
      description: 'Apólice #7890 - MZN 1.250,00',
    ...
    },
    {
      ...
      details: 'Total renovado: MZN 45.600,00 | Próxima renovação: 30 dias',
      icon: <SyncOutlined />,
      status: 'Concluído',
      color: '#8b5cf6',
      bgColor: '#f5f3ff',
