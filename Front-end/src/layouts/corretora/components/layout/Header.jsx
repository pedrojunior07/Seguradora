// src/layouts/corretora/components/layout/Header.jsx
...
const Header = ({ collapsed, setCollapsed, isMobile }) => {
  ...
  const notificationContent = (
    <div style={{ width: isMobile ? '85vw' : 350, maxHeight: 450, overflowY: 'auto' }}>
          ...
          <div key={notif.id}>
            <div
              style={{
                ...
                borderLeft: notif.read_at ? 'none' : '4px solid #000' // Darker accent or custom for Corretora
              }}
      ...
      <div
        ...
        onClick={() => navigate('/corretora/notificacoes')}
      >
  ...
  const profileMenuItems = [
        ...
        <div style={{ padding: '8px 0' }}>
          <Space direction="vertical" size={4} style={{ width: '100%' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              <Avatar size={48} icon={<UserOutlined />} src={entidade?.logo ? getLogoUrl(entidade.logo) : user?.avatar} style={{ background: '#1e293b' }} />
              <div style={{ flex: 1 }}>
    ...
    },
    {
      ...
      icon: <UserOutlined />,
      label: 'Meu Perfil',
      onClick: () => navigate('/corretora/perfil'),
    },
    {
      key: 'configuracoes',
      icon: <SettingOutlined />,
      label: 'Configurações',
      onClick: () => navigate('/corretora/configuracoes'),
    },
    {
      type: 'divider',
    },
